...
% --- MARGINS ---
% Dodajemy pakiet geometry, aby wymusić marginesy.
% Ustawiamy top=3cm zgodnie z prośbą.
% \usepackage{geometry}
% \geometry{paperwidth=594mm,paperheight=841mm, top=3cm, bottom=1.5cm, left=1.5cm, right=1.5cm}
% ----------------------------------
