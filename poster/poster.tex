...
% --- Logo Lewe ---
{
   \begin{minipage}[c]{0.15\textwidth}
     \centering
     \includegraphics[height=0.35\headerheight]{images/logos/UWr_Logo.jpg} \\
     \vspace{0.2em}
     \includegraphics[height=0.32\headerheight]{images/logos/KSI_Logo.png}
   \end{minipage}
}
% --- Tytuł ---
{\color{nustblue}\bf
...
{\color{black}\large
  ...
  \begin{minipage}[t]{0.18\textwidth}
    \centering Jan Burdzicki$^*$ \\ {\small janburdzicki@gmail.com}
  \end{minipage}
  \hspace{0.2cm}
  \begin{minipage}[t]{0.18\textwidth}
    \centering Igor Jakus$^*$ \\ {\small igorjakus@protonmail.com}
  \end{minipage}
  \hspace{0.2cm}
  \begin{minipage}[t]{0.18\textwidth}
    \centering Hubert Berlicki$^*$ \\ {\small berlickihubert@gmail.com}
  \end{minipage}
  \hspace{0.2cm}
  \begin{minipage}[t]{0.25\textwidth}
    \centering Wojciech Aszkiełowicz$^*$ \\ {\small w.aszkielowicz@proton.me}
  \end{minipage}
  \\[0.5em]
...
{
  \vspace{0.5em}
  \includegraphics[height=0.7\headerheight]{images/logos/qrcode.png}
}
...
\textbf{Key Results:}
\begin{itemize}
    \item Standard models: \textbf{85\% clean} vs \textbf{25\% robust} (PGD).
    \item TRADES defense: \textbf{60\% robust accuracy}.
\end{itemize}
\end{posterbox}
...
\begin{posterbox}[name=results, column=2, below=defenses]{Quantitative Results}
...
\begin{posterbox}[name=comparison, column=2, below=results]{Model Comparison}
\centering
\includegraphics[width=0.95\linewidth]{images/results/attack_comparison_original.png}
\captionof{figure}{Robustness across attack methods.}
\end{posterbox}

\begin{posterbox}[name=curves, column=2, below=comparison, above=references]{Robustness Curves}
\centering
\includegraphics[width=0.95\linewidth]{images/results/robustness_comparison_pgd.png}
\captionof{figure}{Accuracy degradation vs. $\epsilon$. TRADES (Green) maintains stability longer than Standard (Blue).}
\end{posterbox}
